...
After adding CSS, I tried to add an image carousel using JavaScript. However, some errors arose, and I am currently working to solve them. This work is available in the "development" branch.
